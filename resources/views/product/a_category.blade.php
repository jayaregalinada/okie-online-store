...
{!! Form::close() !!}
<div class="panel panel-primary" ng-show="categories.length">
    <div class="panel-heading">
        ALL CATEGORIES
    </div>
    <ul class="list-group">
        <li class="animate animated fadeIn list-group-item clearfix" ng-repeat="category in categories">
...
<div class="alert alert-warning" ng-if="!categories.length">
    <p><i class="fa fa-exclamation-triangle"></i> NO CATEGORIES FOUND. Please add new category.</p>
</div>
